    ...
    <div class="controls">
        <div class="input-prepend">
            <select name="category_id" class="input-xlarge">
                <option value="0" <?= ($article['category_id'] == 0) ? 'selected' : null ?>>Без раздела</option>
...
<div class="control-group">
    ...
    <div class="controls">
        <?=Form::textarea('content', $article['content'], array('type' => 'text', 'id' => 'content'))?>
    </div>
</div>
<div class="control-group">
    <div class="controls">
        ...
        <label class="checkbox">
            <input name="status" type="checkbox" <?= $article['status'] ? 'checked' : null ?>> Показать?
        </label><br/>
